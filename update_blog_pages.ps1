$root = Get-Location
$menuPattern = [regex] '<li class="menu-item-has-children"><a href="#">Blog</a>\s*<ul class="sub-menu">\s*<li><a href="blog.html">Blog List</a></li>\s*<li><a href="blog-2.html">Blog Grid</a></li>\s*<li><a href="blog-details.html">Insight Details</a></li>\s*</ul>\s*</li>'
...
foreach ($i in 2..4) {
    ...
    $out | Set-Content -Path (Join-Path $root ('blog-details-' + $i + '.html')) -Encoding UTF8
